...
public class Test {
    ...
    public static void main(String[] args) {
     ...
     int[] migrationRates = new int[]{2};
     int[] generationAmount = new int[]{5};
     ...
     //String[] topologies = new String[]{"ring", "biRing","ladder","complete"};
        ...
        int epochTerminationGeneration = 5; // number of evolution inside the each island i.e. nr. of generation of Master-slave
